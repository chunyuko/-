  ...
  },
  {
    ...
    children: [
      ...
      // },
      {
        path: "/imgs",
        name: "imgs",
        meta: { icon: "picture", title: "图片管理", authority: ["admin", "user"] }, //菜单元信息
        component: () => import(/* webpackChunkName: "user" */ "@/views/Imgs/Imgs.vue"),
      },
      {
        path: "/imgmenu",
        name: "imgmenu",
        meta: { icon: "fund", title: "图片管理", authority: ["admin", "user"], hide: true }, //菜单元信息
        component: () => import(/* webpackChunkName: "user" */ "@/views/Imgmenu/Imgmenu.vue"),
      },
      {
        path: "/videomenu",
        name: "videomenu",
        meta: { icon: "fund", title: "图片管理", authority: ["admin", "user"], hide: true }, //菜单元信息
        component: () => import(/* webpackChunkName: "user" */ "@/views/Videomenu/Videomenu.vue"),
      },
      {
        path: "/videos",
        name: "videos",
        meta: { icon: "video-camera", title: "视频管理", authority: ["admin", "user"] }, //菜单元信息
        component: () => import(/* webpackChunkName: "user" */ "@/views/Videos/Videos.vue"),
      },
      // //sys
      {
        path: "/sys",
